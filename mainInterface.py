...
class FolderInterface():
    ...
    def openDirectory(self):
        self.opened_dir = filedialog.askdirectory() # open file explorer
        self.zip_files = [file for file in os.listdir(self.opened_dir) if file .endswith(".zip")] ## set zip_files
    ...
    def unzipAllBtn(self):
        zip1  = UnzipUtils(self.opened_dir) # imported from unzipUtils.py
        zip1.unzipAll()
    ...
    def deleteZipFiles(self):
        for zfile in self.zip_files: ## NOTE: zip_files is set in openDirectory
